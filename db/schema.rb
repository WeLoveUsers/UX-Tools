...
ActiveRecord::Schema.define(version: 2020_06_02_101023) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "app_notifications", id: :serial, force: :cascade do |t|
    t.datetime "date"
  ...
  create_table "read_app_notifications", id: :serial, force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "response_attrak_diff_abridgeds", id: :serial, force: :cascade do |t|
    t.integer "ATT2"
    t.integer "ATT5"
    t.integer "QP2"
    t.integer "QP3"
  ...
  create_table "response_attrak_diffs", id: :serial, force: :cascade do |t|
    t.integer "ATT1"
    t.integer "ATT2"
    t.integer "ATT3"
    t.integer "ATT4"
  ...
  create_table "response_deeps", id: :serial, force: :cascade do |t|
    t.integer "Q1"
    t.integer "Q2"
    t.integer "Q3"
    t.integer "Q4"
  ...
  create_table "response_sus", id: :serial, force: :cascade do |t|
    t.integer "Q1"
    t.integer "Q2"
    t.integer "Q3"
    t.integer "Q4"
